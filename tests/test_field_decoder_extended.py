"""Extended tests for gem.field_decoder — covering uncovered paths.

Targets: QuantizedFloatDecoder (all flag combinations, decode branches),
_qangle_factory (pitch_yaw, fixed, coord variants), _vector_factory (normal),
_unsigned64_factory (fixed64 branch), find_decoder (all type paths),
find_decoder_by_base_type, and individual primitive decoders.
"""
...
# ---------------------------------------------------------------------------
# find_decoder — dispatch coverage
# ---------------------------------------------------------------------------
