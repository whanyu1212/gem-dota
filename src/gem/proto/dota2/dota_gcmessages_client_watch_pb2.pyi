...
class CSourceTVGameSmall(_message.Message):
    __slots__ = ("activate_time", "deactivate_time", "server_steam_id", "lobby_id", "league_id", "lobby_type", "game_time", "delay", "spectators", "game_mode", "average_mmr", "match_id", "series_id", "team_name_radiant", "team_name_dire", "team_logo_radiant", "team_logo_dire", "team_id_radiant", "team_id_dire", "sort_score", "last_update_time", "radiant_lead", "radiant_score", "dire_score", "players", "building_state", "weekend_tourney_tournament_id", "weekend_tourney_division", "weekend_tourney_skill_level", "weekend_tourney_bracket_round", "custom_game_difficulty", "is_player_draft", "is_watch_eligible")
    class Player(_message.Message):
        ...
        team_slot: int
        team: int
        def __init__(self, account_id: _Optional[int] = ..., hero_id: _Optional[int] = ..., team_slot: _Optional[int] = ..., team: _Optional[int] = ...) -> None: ...
    ...
    def __init__(self, activate_time: _Optional[int] = ..., deactivate_time: _Optional[int] = ..., server_steam_id: _Optional[int] = ..., lobby_id: _Optional[int] = ..., league_id: _Optional[int] = ..., lobby_type: _Optional[int] = ..., game_time: _Optional[int] = ..., delay: _Optional[int] = ..., spectators: _Optional[int] = ..., game_mode: _Optional[int] = ..., average_mmr: _Optional[int] = ..., match_id: _Optional[int] = ..., series_id: _Optional[int] = ..., team_name_radiant: _Optional[str] = ..., team_name_dire: _Optional[str] = ..., team_logo_radiant: _Optional[int] = ..., team_logo_dire: _Optional[int] = ..., team_id_radiant: _Optional[int] = ..., team_id_dire: _Optional[int] = ..., sort_score: _Optional[int] = ..., last_update_time: _Optional[float] = ..., radiant_lead: _Optional[int] = ..., radiant_score: _Optional[int] = ..., dire_score: _Optional[int] = ..., players: _Optional[_Iterable[_Union[CSourceTVGameSmall.Player, _Mapping]]] = ..., building_state: _Optional[int] = ..., weekend_tourney_tournament_id: _Optional[int] = ..., weekend_tourney_division: _Optional[int] = ..., weekend_tourney_skill_level: _Optional[int] = ..., weekend_tourney_bracket_round: _Optional[int] = ..., custom_game_difficulty: _Optional[int] = ..., is_player_draft: bool = ..., is_watch_eligible: bool = ...) -> None: ...
...
class CMsgClientToGCFindTopSourceTVGames(_message.Message):
    ...
    def __init__(self, search_key: _Optional[str] = ..., league_id: _Optional[int] = ..., hero_id: _Optional[int] = ..., start_game: _Optional[int] = ..., game_list_index: _Optional[int] = ..., lobby_ids: _Optional[_Iterable[int]] = ...) -> None: ...

class CMsgGCToClientFindTopSourceTVGamesResponse(_message.Message):
    __slots__ = ("search_key", "league_id", "hero_id", "start_game", "num_games", "game_list_index", "game_list", "specific_games", "bot_game")
    SEARCH_KEY_FIELD_NUMBER: _ClassVar[int]
    LEAGUE_ID_FIELD_NUMBER: _ClassVar[int]
    HERO_ID_FIELD_NUMBER: _ClassVar[int]
    START_GAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, search_key: _Optional[str] = ..., league_id: _Optional[int] = ..., hero_id: _Optional[int] = ..., start_game: _Optional[int] = ..., num_games: _Optional[int] = ..., game_list_index: _Optional[int] = ..., game_list: _Optional[_Iterable[_Union[CSourceTVGameSmall, _Mapping]]] = ..., specific_games: bool = ..., bot_game: _Optional[_Union[CSourceTVGameSmall, _Mapping]] = ...) -> None: ...
...
class CMsgGCToClientTopWeekendTourneyGames(_message.Message):
    ...
    def __init__(self, live_games: _Optional[_Iterable[_Union[CSourceTVGameSmall, _Mapping]]] = ...) -> None: ...
...
class CMsgClientToGCMatchesMinimalResponse(_message.Message):
    ...
    matches: _containers.RepeatedCompositeFieldContainer[_dota_gcmessages_common_pb2.CMsgDOTAMatchMinimal]
    last_match: bool
    def __init__(self, matches: _Optional[_Iterable[_Union[_dota_gcmessages_common_pb2.CMsgDOTAMatchMinimal, _Mapping]]] = ..., last_match: bool = ...) -> None: ...

class CMsgGCToClientTopLeagueMatchesResponse(_message.Message):
    __slots__ = ("matches",)
    MATCHES_FIELD_NUMBER: _ClassVar[int]
    matches: _containers.RepeatedCompositeFieldContainer[_dota_gcmessages_common_pb2.CMsgDOTAMatchMinimal]
    def __init__(self, matches: _Optional[_Iterable[_Union[_dota_gcmessages_common_pb2.CMsgDOTAMatchMinimal, _Mapping]]] = ...) -> None: ...
...
class CMsgSpectateFriendGame(_message.Message):
    ...
    steam_id: int
    live: bool
    def __init__(self, steam_id: _Optional[int] = ..., live: bool = ...) -> None: ...
...
class CMsgSpectateFriendGameResponse(_message.Message):
    ...
    def __init__(self, server_steamid: _Optional[int] = ..., watch_live_result: _Optional[_Union[CMsgSpectateFriendGameResponse.EWatchLiveResult, str]] = ...) -> None: ...
...
class CDOTAReplayDownloadInfo(_message.Message):
    ...
    class Highlight(_message.Message):
        ...
        timestamp: int
        description: str
        def __init__(self, timestamp: _Optional[int] = ..., description: _Optional[str] = ...) -> None: ...
    ...
    exists_on_disk: bool
    def __init__(self, match: _Optional[_Union[_dota_gcmessages_common_pb2.CMsgDOTAMatchMinimal, _Mapping]] = ..., title: _Optional[str] = ..., description: _Optional[str] = ..., size: _Optional[int] = ..., tags: _Optional[_Iterable[str]] = ..., exists_on_disk: bool = ...) -> None: ...
...
class CMsgWatchGame(_message.Message):
    ...
    def __init__(self, server_steamid: _Optional[int] = ..., client_version: _Optional[int] = ..., watch_server_steamid: _Optional[int] = ..., lobby_id: _Optional[int] = ..., regions: _Optional[_Iterable[int]] = ...) -> None: ...
...
class CMsgWatchGameResponse(_message.Message):
    __slots__ = ("watch_game_result", "source_tv_public_addr", "source_tv_private_addr", "source_tv_port", "game_server_steamid", "watch_server_steamid", "watch_tv_unique_secret_code", "broadcast_url")
    ...
    broadcast_url: str
    def __init__(self, watch_game_result: _Optional[_Union[CMsgWatchGameResponse.WatchGameResult, str]] = ..., source_tv_public_addr: _Optional[int] = ..., source_tv_private_addr: _Optional[int] = ..., source_tv_port: _Optional[int] = ..., game_server_steamid: _Optional[int] = ..., watch_server_steamid: _Optional[int] = ..., watch_tv_unique_secret_code: _Optional[int] = ..., broadcast_url: _Optional[str] = ...) -> None: ...

class CMsgPartyLeaderWatchGamePrompt(_message.Message):
    __slots__ = ("game_server_steamid",)
    GAME_SERVER_STEAMID_FIELD_NUMBER: _ClassVar[int]
    game_server_steamid: int
    def __init__(self, game_server_steamid: _Optional[int] = ...) -> None: ...

class CDOTABroadcasterInfo(_message.Message):
    __slots__ = ("account_id", "server_steam_id", "live", "team_name_radiant", "team_name_dire", "series_game", "upcoming_broadcast_timestamp", "allow_live_video", "node_type", "node_name")
    ACCOUNT_ID_FIELD_NUMBER: _ClassVar[int]
    SERVER_STEAM_ID_FIELD_NUMBER: _ClassVar[int]
    LIVE_FIELD_NUMBER: _ClassVar[int]
    TEAM_NAME_RADIANT_FIELD_NUMBER: _ClassVar[int]
    ...
    node_type: int
    node_name: str
    def __init__(self, account_id: _Optional[int] = ..., server_steam_id: _Optional[int] = ..., live: bool = ..., team_name_radiant: _Optional[str] = ..., team_name_dire: _Optional[str] = ..., series_game: _Optional[int] = ..., upcoming_broadcast_timestamp: _Optional[int] = ..., allow_live_video: bool = ..., node_type: _Optional[int] = ..., node_name: _Optional[str] = ...) -> None: ...
...
class CMsgDOTASeries(_message.Message):
    ...
    class TeamInfo(_message.Message):
        ...
        team_logo_url: str
        wager_count: int
        def __init__(self, team_id: _Optional[int] = ..., team_name: _Optional[str] = ..., team_logo_url: _Optional[str] = ..., wager_count: _Optional[int] = ...) -> None: ...
    class LiveGame(_message.Message):
        __slots__ = ("server_steam_id", "team_radiant", "team_dire", "team_radiant_score", "team_dire_score")
        SERVER_STEAM_ID_FIELD_NUMBER: _ClassVar[int]
        ...
        team_dire_score: int
        def __init__(self, server_steam_id: _Optional[int] = ..., team_radiant: _Optional[_Union[CMsgDOTASeries.TeamInfo, _Mapping]] = ..., team_dire: _Optional[_Union[CMsgDOTASeries.TeamInfo, _Mapping]] = ..., team_radiant_score: _Optional[int] = ..., team_dire_score: _Optional[int] = ...) -> None: ...
    SERIES_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    match_minimal: _containers.RepeatedCompositeFieldContainer[_dota_gcmessages_common_pb2.CMsgDOTAMatchMinimal]
    live_game: CMsgDOTASeries.LiveGame
    def __init__(self, series_id: _Optional[int] = ..., series_type: _Optional[int] = ..., team_1: _Optional[_Union[CMsgDOTASeries.TeamInfo, _Mapping]] = ..., team_2: _Optional[_Union[CMsgDOTASeries.TeamInfo, _Mapping]] = ..., match_minimal: _Optional[_Iterable[_Union[_dota_gcmessages_common_pb2.CMsgDOTAMatchMinimal, _Mapping]]] = ..., live_game: _Optional[_Union[CMsgDOTASeries.LiveGame, _Mapping]] = ...) -> None: ...
