...
class CMsgGuildInfo(_message.Message):
    __slots__ = ("guild_name", "guild_tag", "created_timestamp", "guild_language", "guild_flags", "guild_logo", "guild_region", "guild_chat_group_id", "guild_description", "default_chat_channel_id", "guild_primary_color", "guild_secondary_color", "guild_pattern", "guild_refresh_time_offset", "guild_required_rank_tier", "guild_motd_timestamp", "guild_motd")
    ...
    guild_motd: str
    def __init__(self, guild_name: _Optional[str] = ..., guild_tag: _Optional[str] = ..., created_timestamp: _Optional[int] = ..., guild_language: _Optional[int] = ..., guild_flags: _Optional[int] = ..., guild_logo: _Optional[int] = ..., guild_region: _Optional[int] = ..., guild_chat_group_id: _Optional[int] = ..., guild_description: _Optional[str] = ..., default_chat_channel_id: _Optional[int] = ..., guild_primary_color: _Optional[int] = ..., guild_secondary_color: _Optional[int] = ..., guild_pattern: _Optional[int] = ..., guild_refresh_time_offset: _Optional[int] = ..., guild_required_rank_tier: _Optional[int] = ..., guild_motd_timestamp: _Optional[int] = ..., guild_motd: _Optional[str] = ...) -> None: ...

class CMsgGuildSummary(_message.Message):
    __slots__ = ("guild_info", "member_count", "event_points")
    class EventPoints(_message.Message):
        __slots__ = ("event_id", "guild_points", "guild_rank", "guild_weekly_rank", "guild_weekly_percentile", "guild_current_percentile")
        ...
        def __init__(self, event_id: _Optional[int] = ..., guild_points: _Optional[int] = ..., guild_rank: _Optional[int] = ..., guild_weekly_rank: _Optional[int] = ..., guild_weekly_percentile: _Optional[int] = ..., guild_current_percentile: _Optional[int] = ...) -> None: ...
    ...
    def __init__(self, guild_info: _Optional[_Union[CMsgGuildInfo, _Mapping]] = ..., member_count: _Optional[int] = ..., event_points: _Optional[_Iterable[_Union[CMsgGuildSummary.EventPoints, _Mapping]]] = ...) -> None: ...
...
class CMsgGuildRole(_message.Message):
    ...
    role_flags: int
    role_order: int
    def __init__(self, role_id: _Optional[int] = ..., role_name: _Optional[str] = ..., role_flags: _Optional[int] = ..., role_order: _Optional[int] = ...) -> None: ...

class CMsgGuildMember(_message.Message):
    __slots__ = ("member_account_id", "member_role_id", "member_joined_timestamp", "member_last_active_timestamp")
    ...
    def __init__(self, member_account_id: _Optional[int] = ..., member_role_id: _Optional[int] = ..., member_joined_timestamp: _Optional[int] = ..., member_last_active_timestamp: _Optional[int] = ...) -> None: ...
...
class CMsgGuildInvite(_message.Message):
    ...
    timestamp_sent: int
    def __init__(self, requester_account_id: _Optional[int] = ..., target_account_id: _Optional[int] = ..., timestamp_sent: _Optional[int] = ...) -> None: ...
...
class CMsgGuildData(_message.Message):
    ...
    def __init__(self, guild_id: _Optional[int] = ..., guild_info: _Optional[_Union[CMsgGuildInfo, _Mapping]] = ..., guild_roles: _Optional[_Iterable[_Union[CMsgGuildRole, _Mapping]]] = ..., guild_members: _Optional[_Iterable[_Union[CMsgGuildMember, _Mapping]]] = ..., guild_invites: _Optional[_Iterable[_Union[CMsgGuildInvite, _Mapping]]] = ...) -> None: ...
...
class CMsgAccountGuildInvite(_message.Message):
    ...
    requester_account_id: int
    timestamp_sent: int
    def __init__(self, guild_id: _Optional[int] = ..., requester_account_id: _Optional[int] = ..., timestamp_sent: _Optional[int] = ...) -> None: ...
...
class CMsgAccountGuildMemberships(_message.Message):
    ...
    def __init__(self, guild_ids: _Optional[_Iterable[int]] = ..., guild_invites: _Optional[_Iterable[_Union[CMsgAccountGuildInvite, _Mapping]]] = ...) -> None: ...
...
class CMsgGuildPersonaInfo(_message.Message):
    ...
    guild_tag: str
    guild_flags: int
    def __init__(self, guild_id: _Optional[int] = ..., guild_tag: _Optional[str] = ..., guild_flags: _Optional[int] = ...) -> None: ...
...
class CMsgAccountGuildsPersonaInfo(_message.Message):
    ...
    def __init__(self, guild_persona_infos: _Optional[_Iterable[_Union[CMsgGuildPersonaInfo, _Mapping]]] = ...) -> None: ...

class CMsgGuildFeedEvent(_message.Message):
    __slots__ = ("feed_event_id", "timestamp", "event_type", "param_uint_1", "param_uint_2", "param_uint_3")
    ...
    param_uint_2: int
    param_uint_3: int
    def __init__(self, feed_event_id: _Optional[int] = ..., timestamp: _Optional[int] = ..., event_type: _Optional[int] = ..., param_uint_1: _Optional[int] = ..., param_uint_2: _Optional[int] = ..., param_uint_3: _Optional[int] = ...) -> None: ...
...
class CMsgClientToGCCreateGuild(_message.Message):
    ...
    def __init__(self, guild_info: _Optional[_Union[CMsgGuildInfo, _Mapping]] = ..., guild_chat_type: _Optional[_Union[EGuildChatType, str]] = ...) -> None: ...
...
class CMsgClientToGCCreateGuildResponse(_message.Message):
    ...
    guild_id: int
    def __init__(self, result: _Optional[_Union[CMsgClientToGCCreateGuildResponse.EResponse, str]] = ..., guild_id: _Optional[int] = ...) -> None: ...
...
class CMsgClientToGCSetGuildInfo(_message.Message):
    ...
    guild_info: CMsgGuildInfo
    guild_chat_type: EGuildChatType
    def __init__(self, guild_id: _Optional[int] = ..., guild_info: _Optional[_Union[CMsgGuildInfo, _Mapping]] = ..., guild_chat_type: _Optional[_Union[EGuildChatType, str]] = ...) -> None: ...
...
class CMsgClientToGCSetGuildInfoResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCSetGuildInfoResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCRequestGuildDataResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCRequestGuildDataResponse.EResponse, str]] = ..., guild_data: _Optional[_Union[CMsgGuildData, _Mapping]] = ...) -> None: ...
...
class CMsgGCToClientGuildDataUpdated(_message.Message):
    ...
    guild_data: CMsgGuildData
    update_flags: int
    def __init__(self, guild_data: _Optional[_Union[CMsgGuildData, _Mapping]] = ..., update_flags: _Optional[int] = ...) -> None: ...
...
class CMsgGCToClientGuildMembersDataUpdated(_message.Message):
    ...
    def __init__(self, guild_id: _Optional[int] = ..., members_data: _Optional[_Iterable[_Union[CMsgGuildMember, _Mapping]]] = ...) -> None: ...
...
class CMsgClientToGCRequestGuildMembershipResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCRequestGuildMembershipResponse.EResponse, str]] = ..., guild_memberships: _Optional[_Union[CMsgAccountGuildMemberships, _Mapping]] = ...) -> None: ...

class CMsgGCToClientGuildMembershipUpdated(_message.Message):
    __slots__ = ("guild_memberships",)
    GUILD_MEMBERSHIPS_FIELD_NUMBER: _ClassVar[int]
    guild_memberships: CMsgAccountGuildMemberships
    def __init__(self, guild_memberships: _Optional[_Union[CMsgAccountGuildMemberships, _Mapping]] = ...) -> None: ...
...
class CMsgClientToGCJoinGuildResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCJoinGuildResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCLeaveGuildResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCLeaveGuildResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCKickGuildMember(_message.Message):
    ...
    guild_id: int
    target_account_id: int
    def __init__(self, guild_id: _Optional[int] = ..., target_account_id: _Optional[int] = ...) -> None: ...
...
class CMsgClientToGCKickGuildMemberResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCKickGuildMemberResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCSetGuildMemberRole(_message.Message):
    ...
    target_account_id: int
    target_role_id: int
    def __init__(self, guild_id: _Optional[int] = ..., target_account_id: _Optional[int] = ..., target_role_id: _Optional[int] = ...) -> None: ...
...
class CMsgClientToGCSetGuildMemberRoleResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCSetGuildMemberRoleResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCInviteToGuildResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCInviteToGuildResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCDeclineInviteToGuildResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCDeclineInviteToGuildResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCAcceptInviteToGuildResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCAcceptInviteToGuildResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCCancelInviteToGuildResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCCancelInviteToGuildResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCAddGuildRole(_message.Message):
    ...
    role_name: str
    role_flags: int
    def __init__(self, guild_id: _Optional[int] = ..., role_name: _Optional[str] = ..., role_flags: _Optional[int] = ...) -> None: ...
...
class CMsgClientToGCAddGuildRoleResponse(_message.Message):
    ...
    role_id: int
    def __init__(self, result: _Optional[_Union[CMsgClientToGCAddGuildRoleResponse.EResponse, str]] = ..., role_id: _Optional[int] = ...) -> None: ...
...
class CMsgClientToGCModifyGuildRole(_message.Message):
    ...
    role_name: str
    role_flags: int
    def __init__(self, guild_id: _Optional[int] = ..., role_id: _Optional[int] = ..., role_name: _Optional[str] = ..., role_flags: _Optional[int] = ...) -> None: ...
...
class CMsgClientToGCModifyGuildRoleResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCModifyGuildRoleResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCRemoveGuildRole(_message.Message):
    ...
    guild_id: int
    role_id: int
    def __init__(self, guild_id: _Optional[int] = ..., role_id: _Optional[int] = ...) -> None: ...
...
class CMsgClientToGCRemoveGuildRoleResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCRemoveGuildRoleResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCSetGuildRoleOrder(_message.Message):
    ...
    def __init__(self, guild_id: _Optional[int] = ..., requested_role_ids: _Optional[_Iterable[int]] = ..., previous_role_ids: _Optional[_Iterable[int]] = ...) -> None: ...
...
class CMsgClientToGCSetGuildRoleOrderResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCSetGuildRoleOrderResponse.EResponse, str]] = ..., confirmed_role_ids: _Optional[_Iterable[int]] = ...) -> None: ...
...
class CMsgClientToGCGuildFeedRequest(_message.Message):
    ...
    guild_id: int
    last_seen_id: int
    def __init__(self, guild_id: _Optional[int] = ..., last_seen_id: _Optional[int] = ...) -> None: ...
...
class CMsgClientToGCRequestGuildFeedResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCRequestGuildFeedResponse.EResponse, str]] = ..., guild_id: _Optional[int] = ..., feed_events: _Optional[_Iterable[_Union[CMsgGuildFeedEvent, _Mapping]]] = ...) -> None: ...
...
class CMsgClientToGCAddPlayerToGuildChatResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCAddPlayerToGuildChatResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgFindGuildByTagResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgFindGuildByTagResponse.EResponse, str]] = ..., guild_id: _Optional[int] = ..., guild_summary: _Optional[_Union[CMsgGuildSummary, _Mapping]] = ...) -> None: ...
...
class CMsgSearchForOpenGuildsResponse(_message.Message):
    ...
    class SearchResult(_message.Message):
        ...
        guild_id: int
        guild_summary: CMsgGuildSummary
        def __init__(self, guild_id: _Optional[int] = ..., guild_summary: _Optional[_Union[CMsgGuildSummary, _Mapping]] = ...) -> None: ...
    RESULT_FIELD_NUMBER: _ClassVar[int]
    ...
    search_results: _containers.RepeatedCompositeFieldContainer[CMsgSearchForOpenGuildsResponse.SearchResult]
    use_whitelist: bool
    def __init__(self, result: _Optional[_Union[CMsgSearchForOpenGuildsResponse.EResponse, str]] = ..., search_results: _Optional[_Iterable[_Union[CMsgSearchForOpenGuildsResponse.SearchResult, _Mapping]]] = ..., use_whitelist: bool = ...) -> None: ...
...
class CMsgClientToGCReportGuildContent(_message.Message):
    ...
    def __init__(self, guild_id: _Optional[int] = ..., guild_content_flags: _Optional[int] = ...) -> None: ...
...
class CMsgClientToGCReportGuildContentResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCReportGuildContentResponse.EResponse, str]] = ...) -> None: ...
...
class CMsgClientToGCRequestAccountGuildPersonaInfoResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCRequestAccountGuildPersonaInfoResponse.EResponse, str]] = ..., persona_info: _Optional[_Union[CMsgAccountGuildsPersonaInfo, _Mapping]] = ...) -> None: ...
...
class CMsgClientToGCRequestAccountGuildPersonaInfoBatchResponse(_message.Message):
    ...
    class EResponse(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        k_eInternalError: _ClassVar[CMsgClientToGCRequestAccountGuildPersonaInfoBatchResponse.EResponse]
        ...
        k_eInvalidRequest: _ClassVar[CMsgClientToGCRequestAccountGuildPersonaInfoBatchResponse.EResponse]
    ...
    def __init__(self, result: _Optional[_Union[CMsgClientToGCRequestAccountGuildPersonaInfoBatchResponse.EResponse, str]] = ..., persona_infos: _Optional[_Iterable[_Union[CMsgAccountGuildsPersonaInfo, _Mapping]]] = ...) -> None: ...
