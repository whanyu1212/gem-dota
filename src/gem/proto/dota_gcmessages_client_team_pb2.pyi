...
class CMsgDOTATeamInfo(_message.Message):
    __slots__ = ("members", "team_id", "name", "tag", "time_created", "pro", "pickup_team", "ugc_logo", "ugc_base_logo", "ugc_banner_logo", "ugc_sponsor_logo", "country_code", "url", "wins", "losses", "games_played_total", "games_played_matchmaking", "url_logo", "audit_entries", "region", "abbreviation", "member_stats", "team_stats", "dpc_results", "color_primary", "color_secondary", "team_captain")
    class HeroStats(_message.Message):
        __slots__ = ("hero_id", "picks", "wins", "bans", "avg_kills", "avg_deaths", "avg_assists", "avg_gpm", "avg_xpm")
        ...
        avg_gpm: float
        avg_xpm: float
        def __init__(self, hero_id: _Optional[int] = ..., picks: _Optional[int] = ..., wins: _Optional[int] = ..., bans: _Optional[int] = ..., avg_kills: _Optional[float] = ..., avg_deaths: _Optional[float] = ..., avg_assists: _Optional[float] = ..., avg_gpm: _Optional[float] = ..., avg_xpm: _Optional[float] = ...) -> None: ...
    class MemberStats(_message.Message):
        __slots__ = ("account_id", "wins_with_team", "losses_with_team", "top_heroes", "avg_kills", "avg_deaths", "avg_assists")
        ...
        avg_deaths: float
        avg_assists: float
        def __init__(self, account_id: _Optional[int] = ..., wins_with_team: _Optional[int] = ..., losses_with_team: _Optional[int] = ..., top_heroes: _Optional[_Iterable[_Union[CMsgDOTATeamInfo.HeroStats, _Mapping]]] = ..., avg_kills: _Optional[float] = ..., avg_deaths: _Optional[float] = ..., avg_assists: _Optional[float] = ...) -> None: ...
    class TeamStats(_message.Message):
        __slots__ = ("played_heroes", "farming", "fighting", "versatility", "avg_kills", "avg_deaths", "avg_duration")
        ...
        avg_deaths: float
        avg_duration: float
        def __init__(self, played_heroes: _Optional[_Iterable[_Union[CMsgDOTATeamInfo.HeroStats, _Mapping]]] = ..., farming: _Optional[float] = ..., fighting: _Optional[float] = ..., versatility: _Optional[float] = ..., avg_kills: _Optional[float] = ..., avg_deaths: _Optional[float] = ..., avg_duration: _Optional[float] = ...) -> None: ...
    ...
    class Member(_message.Message):
        ...
        real_name: str
        def __init__(self, account_id: _Optional[int] = ..., time_joined: _Optional[int] = ..., admin: bool = ..., pro_name: _Optional[str] = ..., role: _Optional[_Union[_dota_shared_enums_pb2.Fantasy_Roles, str]] = ..., real_name: _Optional[str] = ...) -> None: ...
    class AuditEntry(_message.Message):
        ...
        timestamp: int
        account_id: int
        def __init__(self, audit_action: _Optional[int] = ..., timestamp: _Optional[int] = ..., account_id: _Optional[int] = ...) -> None: ...
    ...
    color_secondary: str
    team_captain: int
    def __init__(self, members: _Optional[_Iterable[_Union[CMsgDOTATeamInfo.Member, _Mapping]]] = ..., team_id: _Optional[int] = ..., name: _Optional[str] = ..., tag: _Optional[str] = ..., time_created: _Optional[int] = ..., pro: bool = ..., pickup_team: bool = ..., ugc_logo: _Optional[int] = ..., ugc_base_logo: _Optional[int] = ..., ugc_banner_logo: _Optional[int] = ..., ugc_sponsor_logo: _Optional[int] = ..., country_code: _Optional[str] = ..., url: _Optional[str] = ..., wins: _Optional[int] = ..., losses: _Optional[int] = ..., games_played_total: _Optional[int] = ..., games_played_matchmaking: _Optional[int] = ..., url_logo: _Optional[str] = ..., audit_entries: _Optional[_Iterable[_Union[CMsgDOTATeamInfo.AuditEntry, _Mapping]]] = ..., region: _Optional[_Union[_dota_shared_enums_pb2.ELeagueRegion, str]] = ..., abbreviation: _Optional[str] = ..., member_stats: _Optional[_Iterable[_Union[CMsgDOTATeamInfo.MemberStats, _Mapping]]] = ..., team_stats: _Optional[_Union[CMsgDOTATeamInfo.TeamStats, _Mapping]] = ..., dpc_results: _Optional[_Iterable[_Union[CMsgDOTATeamInfo.DPCResult, _Mapping]]] = ..., color_primary: _Optional[str] = ..., color_secondary: _Optional[str] = ..., team_captain: _Optional[int] = ...) -> None: ...
...
class CMsgDOTATeamsInfo(_message.Message):
    ...
    def __init__(self, league_id: _Optional[int] = ..., teams: _Optional[_Iterable[_Union[CMsgDOTATeamInfo, _Mapping]]] = ...) -> None: ...

class CMsgDOTATeamInfoList(_message.Message):
    __slots__ = ("teams",)
    TEAMS_FIELD_NUMBER: _ClassVar[int]
    teams: _containers.RepeatedCompositeFieldContainer[CMsgDOTATeamInfo]
    def __init__(self, teams: _Optional[_Iterable[_Union[CMsgDOTATeamInfo, _Mapping]]] = ...) -> None: ...
...
class CMsgDOTATeamInfoCache(_message.Message):
    ...
    def __init__(self, cache_timestamp: _Optional[int] = ..., team_list: _Optional[_Union[CMsgDOTATeamInfoList, _Mapping]] = ...) -> None: ...
...
class CMsgDOTACreateTeam(_message.Message):
    __slots__ = ("name", "tag", "logo", "base_logo", "banner_logo", "sponsor_logo", "country_code", "url", "pickup_team", "abbreviation")
    NAME_FIELD_NUMBER: _ClassVar[int]
    TAG_FIELD_NUMBER: _ClassVar[int]
    ...
    pickup_team: bool
    abbreviation: str
    def __init__(self, name: _Optional[str] = ..., tag: _Optional[str] = ..., logo: _Optional[int] = ..., base_logo: _Optional[int] = ..., banner_logo: _Optional[int] = ..., sponsor_logo: _Optional[int] = ..., country_code: _Optional[str] = ..., url: _Optional[str] = ..., pickup_team: bool = ..., abbreviation: _Optional[str] = ...) -> None: ...
...
class CMsgDOTACreateTeamResponse(_message.Message):
    ...
    team_id: int
    def __init__(self, result: _Optional[_Union[CMsgDOTACreateTeamResponse.Result, str]] = ..., team_id: _Optional[int] = ...) -> None: ...

class CMsgDOTAEditTeamDetails(_message.Message):
    __slots__ = ("team_id", "name", "tag", "logo", "base_logo", "banner_logo", "sponsor_logo", "country_code", "url", "in_use_by_party", "abbreviation")
    TEAM_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    TAG_FIELD_NUMBER: _ClassVar[int]
    LOGO_FIELD_NUMBER: _ClassVar[int]
    ...
    abbreviation: str
    def __init__(self, team_id: _Optional[int] = ..., name: _Optional[str] = ..., tag: _Optional[str] = ..., logo: _Optional[int] = ..., base_logo: _Optional[int] = ..., banner_logo: _Optional[int] = ..., sponsor_logo: _Optional[int] = ..., country_code: _Optional[str] = ..., url: _Optional[str] = ..., in_use_by_party: bool = ..., abbreviation: _Optional[str] = ...) -> None: ...
...
class CMsgDOTAEditTeamDetailsResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgDOTAEditTeamDetailsResponse.Result, str]] = ...) -> None: ...
...
class CMsgDOTATeamInvite_InviterToGC(_message.Message):
    ...
    account_id: int
    team_id: int
    def __init__(self, account_id: _Optional[int] = ..., team_id: _Optional[int] = ...) -> None: ...
...
class CMsgDOTATeamInvite_GCImmediateResponseToInviter(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[ETeamInviteResult, str]] = ..., invitee_name: _Optional[str] = ..., required_play_time: _Optional[int] = ...) -> None: ...
...
class CMsgDOTATeamInvite_GCRequestToInvitee(_message.Message):
    ...
    team_tag: str
    logo: int
    def __init__(self, inviter_account_id: _Optional[int] = ..., team_name: _Optional[str] = ..., team_tag: _Optional[str] = ..., logo: _Optional[int] = ...) -> None: ...

class CMsgDOTATeamInvite_InviteeResponseToGC(_message.Message):
    __slots__ = ("result",)
    RESULT_FIELD_NUMBER: _ClassVar[int]
    result: ETeamInviteResult
    def __init__(self, result: _Optional[_Union[ETeamInviteResult, str]] = ...) -> None: ...
...
class CMsgDOTATeamInvite_GCResponseToInviter(_message.Message):
    ...
    result: ETeamInviteResult
    invitee_name: str
    def __init__(self, result: _Optional[_Union[ETeamInviteResult, str]] = ..., invitee_name: _Optional[str] = ...) -> None: ...
...
class CMsgDOTATeamInvite_GCResponseToInvitee(_message.Message):
    ...
    result: ETeamInviteResult
    team_name: str
    def __init__(self, result: _Optional[_Union[ETeamInviteResult, str]] = ..., team_name: _Optional[str] = ...) -> None: ...
...
class CMsgDOTAKickTeamMemberResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgDOTAKickTeamMemberResponse.Result, str]] = ...) -> None: ...
...
class CMsgDOTATransferTeamAdmin(_message.Message):
    ...
    team_id: int
    def __init__(self, new_admin_account_id: _Optional[int] = ..., team_id: _Optional[int] = ...) -> None: ...
...
class CMsgDOTATransferTeamAdminResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgDOTATransferTeamAdminResponse.Result, str]] = ...) -> None: ...
...
class CMsgDOTALeaveTeamResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[CMsgDOTALeaveTeamResponse.Result, str]] = ...) -> None: ...

class CMsgDOTABetaParticipation(_message.Message):
    __slots__ = ("access_rights",)
    ACCESS_RIGHTS_FIELD_NUMBER: _ClassVar[int]
    access_rights: int
    def __init__(self, access_rights: _Optional[int] = ...) -> None: ...
