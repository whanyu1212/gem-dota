from . import netmessages_pb2 as _netmessages_pb2
...
class CMsgFightingGame_GameData_Fighting(_message.Message):
    __slots__ = ("last_acked_frame", "player_id", "last_crc_frame", "last_crc_value", "now", "peer_ack_time", "input_start_frame", "input_sample")
    class InputSample(_message.Message):
        __slots__ = ("button_mask",)
        BUTTON_MASK_FIELD_NUMBER: _ClassVar[int]
        button_mask: int
        def __init__(self, button_mask: _Optional[int] = ...) -> None: ...
    ...
    input_sample: _containers.RepeatedCompositeFieldContainer[CMsgFightingGame_GameData_Fighting.InputSample]
    def __init__(self, last_acked_frame: _Optional[int] = ..., player_id: _Optional[int] = ..., last_crc_frame: _Optional[int] = ..., last_crc_value: _Optional[int] = ..., now: _Optional[float] = ..., peer_ack_time: _Optional[float] = ..., input_start_frame: _Optional[int] = ..., input_sample: _Optional[_Iterable[_Union[CMsgFightingGame_GameData_Fighting.InputSample, _Mapping]]] = ...) -> None: ...

class CMsgFightingGame_GameData_CharacterSelect(_message.Message):
    __slots__ = ("cursor_index", "selected_hero_id", "selected_style", "econ_item_refs", "message_ack", "confirmed_style")
    class Item(_message.Message):
        ...
        item_def: int
        style_index: int
        def __init__(self, item_def: _Optional[int] = ..., style_index: _Optional[int] = ...) -> None: ...
    ...
    selected_style: int
    econ_item_refs: _containers.RepeatedCompositeFieldContainer[CMsgFightingGame_GameData_CharacterSelect.Item]
    message_ack: int
    confirmed_style: bool
    def __init__(self, cursor_index: _Optional[int] = ..., selected_hero_id: _Optional[int] = ..., selected_style: _Optional[int] = ..., econ_item_refs: _Optional[_Iterable[_Union[CMsgFightingGame_GameData_CharacterSelect.Item, _Mapping]]] = ..., message_ack: _Optional[int] = ..., confirmed_style: bool = ...) -> None: ...
...
class CMsgFightingGame_GameData_Loaded(_message.Message):
    ...
    def __init__(self, now: _Optional[float] = ..., peer_ack_time: _Optional[float] = ..., proposed_start_time: _Optional[float] = ..., accepted_start_time: _Optional[float] = ...) -> None: ...
...
class CP2P_FightingGame_GameData(_message.Message):
    ...
    def __init__(self, state: _Optional[_Union[CP2P_FightingGame_GameData.EState, str]] = ..., fight: _Optional[_Union[CMsgFightingGame_GameData_Fighting, _Mapping]] = ..., character_select: _Optional[_Union[CMsgFightingGame_GameData_CharacterSelect, _Mapping]] = ..., loaded: _Optional[_Union[CMsgFightingGame_GameData_Loaded, _Mapping]] = ...) -> None: ...
